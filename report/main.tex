...
Figure~\ref{fig:datacenter_demand} shows the assumptions for electricity demand from
datacenters. The load profile is assumed constant, and a corresponding demand response
potential is assumed for configurations with flexible datacenter demand.
